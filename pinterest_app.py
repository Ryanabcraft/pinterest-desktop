#!/usr/bin/env python3
"""Pinterest Desktop — abre Pinterest no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/pinterest-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"Pinterest Desktop v{new_ver} disponível!\n\n"
